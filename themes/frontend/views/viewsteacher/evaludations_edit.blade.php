...
{{$evaluations->studant_id }}
<div class="min-h-screen bg-gray-100 p-0 sm:p-12">

  <div class="mx-auto max-w-md px-6 py-12 bg-white border-0 shadow-lg sm:rounded-3xl">
    تقيم
    <form id="form" action="{{route('evaluation.update',$evaluations)}}" method="POST" enctype="multipart/form-data">
      @csrf
      @method('PUT')
      <input
        type=""
        name="student_id"
    value="{{$evaluations->student_id }}"
    >
    <input
    type="hidden"
    name="subject_id"
value="{{$evaluations->subject_id }}"
>
      ...
      <div class="relative z-0 w-full mb-5">
        ...
        <span class="text-sm text-red-600 hidden" id="error">ملحوظة</span>
      </div>
