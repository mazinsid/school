...
<html>
    <head>
        ...
        <link rel="stylesheet" href="{{asset('css/tailwind.min.css')}}" type="text/css" media="screen" title="no title" charset="utf-8" />
    </head>
    <body class>
        <div class="lg:flex">
            <div class="lg:w-1/2 xl:max-w-screen-sm">
                <div class="py-12 bg-indigo-100 lg:bg-white flex justify-center lg:justify-start lg:px-12">
                    <div class="cursor-pointer flex items-center">
                        <div>
                            <img class="w-16 h-16 rounded-full mx-auto" src="{{asset('img/school.jpeg')}}" />
                       
                        </div>
                        <div class="text-2xl text-indigo-800 tracking-wide ml-2 font-semibold">مدرسة الأنشراح</div>
                    </div>
                </div>
                <div class="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
                    <h2 class="text-center text-4xl text-indigo-900 font-display font-semibold lg:text-left xl:text-5xl
                    xl:text-bold">تسجل الدخول</h2>
                    <div class="mt-12">
                        <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8" method="POST" action="{{ route('login') }}">
                            @csrf
        
                            <div>
                                <div class="text-sm font-bold text-gray-700 tracking-wide">أسم المستخدم</div>
                                <input  class="w-full text-lg py-2 border-b border-gray-300 
                                focus:outline-none focus:border-indigo-500 @error('name') border-red-500 @enderror" name="name"
                                value="{{ old('name') }}" required autocomplete="name" type="text" placeholder="أسم المستخدم">
                            </div>
                            <div class="mt-8">
                                ...
                                <input class="w-full text-lg py-2 border-b border-gray-300
                                 focus:outline-none focus:border-indigo-500 border-red-500 " name="password"
                    ...
                    <div class="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                       هل لديك حساب ? <a href="{{ route('register') }}" class="cursor-pointer
                        text-indigo-600 hover:text-indigo-800">تسجيل</a>
                    </div>
                </div>
            </div>
